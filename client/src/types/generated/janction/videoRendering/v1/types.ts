...
export interface GenesisState {
  ...
  audioStemTaskList: IndexedAudioStemTask[];
  /** List of Workers */
  workers: Worker[];
}
 ...
 */
export interface AudioStemTask {
  taskId: string;
  requester: string;
  cid: string;
  startFrame: number;
 ...
 */
export interface AudioStemThread {
  threadId: string;
  taskId: string;
  startFrame: Long;
  endFrame: Long;
  completed: boolean;
  workers: string[];
  solution?: AudioStemThread_Solution | undefined;
  validations: AudioStemThread_Validation[];
  averageRenderSeconds: Long;
}

export interface AudioStemThread_Solution {
  proposedBy: string;
...
export interface AudioStemThread_Validation {
  validator: string;
  frames: AudioStemThread_Frame[];
  publicKey: string;
  isReverse: boolean;
...
export interface AudioStemThread_Frame {
  filename: string;
  signature: string;
  cid: string;
  hash: string;
...
export interface AudioStemTaskInfo {
  nextId: Long;
}

/** Stores the Video Rendering Task with the index */
export interface IndexedAudioStemTask {
  index: string;
  audioStemTask?: AudioStemTask | undefined;
}

export interface AudioStemLogs {
  threadId: string;
  logs: AudioStemLogs_AudioStemLog[];
}

export interface AudioStemLogs_AudioStemLog {
  log: string;
  timestamp: Long;
  severity: AudioStemLogs_AudioStemLog_SEVERITY;
}

export enum AudioStemLogs_AudioStemLog_SEVERITY {
  INFO = 0,
  SUCCESS = 1,
  ERROR = 2,
  UNRECOGNIZED = -1,
...
export function audioStemLogs_AudioStemLog_SEVERITYFromJSON(
  object: any,
): AudioStemLogs_AudioStemLog_SEVERITY {
  switch (object) {
    case 0:
    case "INFO":
      return AudioStemLogs_AudioStemLog_SEVERITY.INFO;
    case 1:
    case "SUCCESS":
      return AudioStemLogs_AudioStemLog_SEVERITY.SUCCESS;
    case 2:
    case "ERROR":
      return AudioStemLogs_AudioStemLog_SEVERITY.ERROR;
    case -1:
    case "UNRECOGNIZED":
    default:
      return AudioStemLogs_AudioStemLog_SEVERITY.UNRECOGNIZED;
  }
}

export function audioStemLogs_AudioStemLog_SEVERITYToJSON(
  object: AudioStemLogs_AudioStemLog_SEVERITY,
): string {
  switch (object) {
    case AudioStemLogs_AudioStemLog_SEVERITY.INFO:
      return "INFO";
    case AudioStemLogs_AudioStemLog_SEVERITY.SUCCESS:
      return "SUCCESS";
    case AudioStemLogs_AudioStemLog_SEVERITY.ERROR:
      return "ERROR";
    case AudioStemLogs_AudioStemLog_SEVERITY.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, audioStemTaskInfo: undefined, audioStemTaskList: [], workers: [] };
}
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.audioStemTaskInfo !== undefined) {
      AudioStemTaskInfo.encode(message.audioStemTaskInfo, writer.uint32(26).fork()).join();
    }
    for (const v of message.audioStemTaskList) {
      IndexedAudioStemTask.encode(v!, writer.uint32(34).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.audioStemTaskInfo = AudioStemTaskInfo.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.audioStemTaskList.push(IndexedAudioStemTask.decode(reader, reader.uint32()));
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      audioStemTaskInfo: isSet(object.audioStemTaskInfo)
        ? AudioStemTaskInfo.fromJSON(object.audioStemTaskInfo)
        : undefined,
      audioStemTaskList: globalThis.Array.isArray(object?.audioStemTaskList)
        ? object.audioStemTaskList.map((e: any) => IndexedAudioStemTask.fromJSON(e))
        : [],
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.audioStemTaskInfo !== undefined) {
      obj.audioStemTaskInfo = AudioStemTaskInfo.toJSON(message.audioStemTaskInfo);
    }
    if (message.audioStemTaskList?.length) {
      obj.audioStemTaskList = message.audioStemTaskList.map((e) => IndexedAudioStemTask.toJSON(e));
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.audioStemTaskInfo =
      (object.audioStemTaskInfo !== undefined && object.audioStemTaskInfo !== null)
        ? AudioStemTaskInfo.fromPartial(object.audioStemTaskInfo)
        : undefined;
    message.audioStemTaskList =
      object.audioStemTaskList?.map((e) => IndexedAudioStemTask.fromPartial(e)) || [];
...
function createBaseAudioStemTask(): AudioStemTask {
  return {
    taskId: "",
    requester: "",
    cid: "",
...
export const AudioStemTask: MessageFns<AudioStemTask> = {
  encode(message: AudioStemTask, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.taskId !== "") {
    ...
    for (const v of message.threads) {
      AudioStemThread.encode(v!, writer.uint32(74).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemTask {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemTask();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 9: {
          ...
          message.threads.push(AudioStemThread.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): AudioStemTask {
    return {
      ...
      threads: globalThis.Array.isArray(object?.threads)
        ? object.threads.map((e: any) => AudioStemThread.fromJSON(e))
        : [],
    };
  },

  toJSON(message: AudioStemTask): unknown {
    const obj: any = {};
    if (message.taskId !== "") {
    ...
    if (message.threads?.length) {
      obj.threads = message.threads.map((e) => AudioStemThread.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<AudioStemTask>, I>>(base?: I): AudioStemTask {
    return AudioStemTask.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemTask>, I>>(object: I): AudioStemTask {
    const message = createBaseAudioStemTask();
    ...
    message.reward = (object.reward !== undefined && object.reward !== null)
      ...
      : undefined;
    message.threads = object.threads?.map((e) => AudioStemThread.fromPartial(e)) || [];
    return message;
  },
};

function createBaseAudioStemThread(): AudioStemThread {
  return {
    threadId: "",
    taskId: "",
...
export const AudioStemThread: MessageFns<AudioStemThread> = {
  encode(message: AudioStemThread, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.threadId !== "") {
    ...
    if (message.solution !== undefined) {
      AudioStemThread_Solution.encode(message.solution, writer.uint32(58).fork()).join();
    }
    for (const v of message.validations) {
      AudioStemThread_Validation.encode(v!, writer.uint32(66).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemThread {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemThread();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 7: {
          ...
          message.solution = AudioStemThread_Solution.decode(reader, reader.uint32());
          continue;
        }
        case 8: {
          if (tag !== 66) {
          ...
          message.validations.push(AudioStemThread_Validation.decode(reader, reader.uint32()));
          continue;
        }
        case 9: {
          if (tag !== 72) {
  ...
  fromJSON(object: any): AudioStemThread {
    return {
      ...
      solution: isSet(object.solution) ? AudioStemThread_Solution.fromJSON(object.solution) : undefined,
      validations: globalThis.Array.isArray(object?.validations)
        ? object.validations.map((e: any) => AudioStemThread_Validation.fromJSON(e))
        : [],
  ...
  toJSON(message: AudioStemThread): unknown {
    const obj: any = {};
    if (message.threadId !== "") {
    ...
    if (message.solution !== undefined) {
      obj.solution = AudioStemThread_Solution.toJSON(message.solution);
    }
    if (message.validations?.length) {
      obj.validations = message.validations.map((e) => AudioStemThread_Validation.toJSON(e));
    }
    if (!message.averageRenderSeconds.equals(Long.ZERO)) {
  ...
  create<I extends Exact<DeepPartial<AudioStemThread>, I>>(base?: I): AudioStemThread {
    return AudioStemThread.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemThread>, I>>(object: I): AudioStemThread {
    const message = createBaseAudioStemThread();
    ...
    message.solution = (object.solution !== undefined && object.solution !== null)
      ? AudioStemThread_Solution.fromPartial(object.solution)
      : undefined;
    message.validations = object.validations?.map((e) => AudioStemThread_Validation.fromPartial(e)) || [];
...
function createBaseAudioStemThread_Solution(): AudioStemThread_Solution {
  return { proposedBy: "", frames: [], publicKey: "", dir: "", accepted: false };
}

export const AudioStemThread_Solution: MessageFns<AudioStemThread_Solution> = {
  encode(message: AudioStemThread_Solution, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.proposedBy !== "") {
      writer.uint32(10).string(message.proposedBy);
    }
    for (const v of message.frames) {
      AudioStemThread_Frame.encode(v!, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemThread_Solution {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemThread_Solution();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.frames.push(AudioStemThread_Frame.decode(reader, reader.uint32()));
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  toJSON(message: AudioStemThread_Solution): unknown {
    const obj: any = {};
    if (message.proposedBy !== "") {
      obj.proposedBy = message.proposedBy;
    }
    if (message.frames?.length) {
      obj.frames = message.frames.map((e) => AudioStemThread_Frame.toJSON(e));
    }
    if (message.publicKey !== "") {
  ...
  create<I extends Exact<DeepPartial<AudioStemThread_Solution>, I>>(base?: I): AudioStemThread_Solution {
    return AudioStemThread_Solution.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemThread_Solution>, I>>(
    object: I,
  ): AudioStemThread_Solution {
    const message = createBaseAudioStemThread_Solution();
    message.proposedBy = object.proposedBy ?? "";
    message.frames = object.frames?.map((e) => AudioStemThread_Frame.fromPartial(e)) || [];
...
function createBaseAudioStemThread_Validation(): AudioStemThread_Validation {
  return { validator: "", frames: [], publicKey: "", isReverse: false };
}

export const AudioStemThread_Validation: MessageFns<AudioStemThread_Validation> = {
  encode(message: AudioStemThread_Validation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemThread_Validation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemThread_Validation();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AudioStemThread_Validation {
    return {
  ...
  toJSON(message: AudioStemThread_Validation): unknown {
    const obj: any = {};
    if (message.validator !== "") {
  ...
  create<I extends Exact<DeepPartial<AudioStemThread_Validation>, I>>(base?: I): AudioStemThread_Validation {
    return AudioStemThread_Validation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemThread_Validation>, I>>(
    object: I,
  ): AudioStemThread_Validation {
    const message = createBaseAudioStemThread_Validation();
...
function createBaseAudioStemThread_Frame(): AudioStemThread_Frame {
  return { filename: "", signature: "", cid: "", hash: "", validCount: Long.ZERO, invalidCount: Long.ZERO };
}

export const AudioStemThread_Frame: MessageFns<AudioStemThread_Frame> = {
  encode(message: AudioStemThread_Frame, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filename !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemThread_Frame {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemThread_Frame();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AudioStemThread_Frame {
    return {
  ...
  toJSON(message: AudioStemThread_Frame): unknown {
    const obj: any = {};
    if (message.filename !== "") {
  ...
  create<I extends Exact<DeepPartial<AudioStemThread_Frame>, I>>(base?: I): AudioStemThread_Frame {
    return AudioStemThread_Frame.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemThread_Frame>, I>>(object: I): AudioStemThread_Frame {
    const message = createBaseAudioStemThread_Frame();
...
function createBaseAudioStemTaskInfo(): AudioStemTaskInfo {
  return { nextId: Long.ZERO };
}

export const AudioStemTaskInfo: MessageFns<AudioStemTaskInfo> = {
  encode(message: AudioStemTaskInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemTaskInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemTaskInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AudioStemTaskInfo {
    return { nextId: isSet(object.nextId) ? Long.fromValue(object.nextId) : Long.ZERO };
  },

  toJSON(message: AudioStemTaskInfo): unknown {
    const obj: any = {};
    if (!message.nextId.equals(Long.ZERO)) {
  ...
  create<I extends Exact<DeepPartial<AudioStemTaskInfo>, I>>(base?: I): AudioStemTaskInfo {
    return AudioStemTaskInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemTaskInfo>, I>>(object: I): AudioStemTaskInfo {
    const message = createBaseAudioStemTaskInfo();
...
function createBaseIndexedAudioStemTask(): IndexedAudioStemTask {
  return { index: "", audioStemTask: undefined };
}

export const IndexedAudioStemTask: MessageFns<IndexedAudioStemTask> = {
  encode(message: IndexedAudioStemTask, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.index !== "") {
      writer.uint32(10).string(message.index);
    }
    if (message.audioStemTask !== undefined) {
      AudioStemTask.encode(message.audioStemTask, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IndexedAudioStemTask {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIndexedAudioStemTask();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IndexedAudioStemTask {
    return {
  ...
  toJSON(message: IndexedAudioStemTask): unknown {
    const obj: any = {};
    if (message.index !== "") {
  ...
  create<I extends Exact<DeepPartial<IndexedAudioStemTask>, I>>(base?: I): IndexedAudioStemTask {
    return IndexedAudioStemTask.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IndexedAudioStemTask>, I>>(object: I): IndexedAudioStemTask {
    const message = createBaseIndexedAudioStemTask();
...
function createBaseAudioStemLogs(): AudioStemLogs {
  return { threadId: "", logs: [] };
}

export const AudioStemLogs: MessageFns<AudioStemLogs> = {
  encode(message: AudioStemLogs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.threadId !== "") {
      writer.uint32(10).string(message.threadId);
    }
    for (const v of message.logs) {
      AudioStemLogs_AudioStemLog.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemLogs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemLogs();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.logs.push(AudioStemLogs_AudioStemLog.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): AudioStemLogs {
    return {
      threadId: isSet(object.threadId) ? globalThis.String(object.threadId) : "",
      logs: globalThis.Array.isArray(object?.logs)
        ? object.logs.map((e: any) => AudioStemLogs_AudioStemLog.fromJSON(e))
        : [],
    };
  },

  toJSON(message: AudioStemLogs): unknown {
    const obj: any = {};
    if (message.threadId !== "") {
      obj.threadId = message.threadId;
    }
    if (message.logs?.length) {
      obj.logs = message.logs.map((e) => AudioStemLogs_AudioStemLog.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<AudioStemLogs>, I>>(base?: I): AudioStemLogs {
    return AudioStemLogs.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemLogs>, I>>(object: I): AudioStemLogs {
    const message = createBaseAudioStemLogs();
    message.threadId = object.threadId ?? "";
    message.logs = object.logs?.map((e) => AudioStemLogs_AudioStemLog.fromPartial(e)) || [];
    return message;
  },
};

function createBaseAudioStemLogs_AudioStemLog(): AudioStemLogs_AudioStemLog {
  return { log: "", timestamp: Long.ZERO, severity: 0 };
}

export const AudioStemLogs_AudioStemLog: MessageFns<AudioStemLogs_AudioStemLog> = {
  encode(message: AudioStemLogs_AudioStemLog, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.log !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AudioStemLogs_AudioStemLog {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAudioStemLogs_AudioStemLog();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2: {
  ...
  fromJSON(object: any): AudioStemLogs_AudioStemLog {
    return {
      log: isSet(object.log) ? globalThis.String(object.log) : "",
      timestamp: isSet(object.timestamp) ? Long.fromValue(object.timestamp) : Long.ZERO,
      severity: isSet(object.severity) ? audioStemLogs_AudioStemLog_SEVERITYFromJSON(object.severity) : 0,
    };
  },

  toJSON(message: AudioStemLogs_AudioStemLog): unknown {
    const obj: any = {};
    if (message.log !== "") {
      obj.log = message.log;
    }
    ...
    if (message.severity !== 0) {
      obj.severity = audioStemLogs_AudioStemLog_SEVERITYToJSON(message.severity);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<AudioStemLogs_AudioStemLog>, I>>(
    base?: I,
  ): AudioStemLogs_AudioStemLog {
    return AudioStemLogs_AudioStemLog.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AudioStemLogs_AudioStemLog>, I>>(
    object: I,
  ): AudioStemLogs_AudioStemLog {
    const message = createBaseAudioStemLogs_AudioStemLog();
