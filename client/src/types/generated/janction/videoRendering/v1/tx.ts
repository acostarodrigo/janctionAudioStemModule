...
export interface MsgCreateAudioStemTask {
...
export interface MsgCreateAudioStemTaskResponse {
  taskId: string;
}
...
function createBaseMsgCreateAudioStemTask(): MsgCreateAudioStemTask {
  return { creator: "", cid: "", startFrame: 0, endFrame: 0, threads: 0, reward: undefined };
}

export const MsgCreateAudioStemTask: MessageFns<MsgCreateAudioStemTask> = {
  encode(message: MsgCreateAudioStemTask, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateAudioStemTask {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgCreateAudioStemTask();
  ...
  fromJSON(object: any): MsgCreateAudioStemTask {
    return {
  ...
  toJSON(message: MsgCreateAudioStemTask): unknown {
    const obj: any = {};
    if (message.creator !== "") {
  ...
  create<I extends Exact<DeepPartial<MsgCreateAudioStemTask>, I>>(base?: I): MsgCreateAudioStemTask {
    return MsgCreateAudioStemTask.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgCreateAudioStemTask>, I>>(object: I): MsgCreateAudioStemTask {
    const message = createBaseMsgCreateAudioStemTask();
...
function createBaseMsgCreateAudioStemTaskResponse(): MsgCreateAudioStemTaskResponse {
  return { taskId: "" };
}

export const MsgCreateAudioStemTaskResponse: MessageFns<MsgCreateAudioStemTaskResponse> = {
  encode(message: MsgCreateAudioStemTaskResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.taskId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateAudioStemTaskResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgCreateAudioStemTaskResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): MsgCreateAudioStemTaskResponse {
    return { taskId: isSet(object.taskId) ? globalThis.String(object.taskId) : "" };
  },

  toJSON(message: MsgCreateAudioStemTaskResponse): unknown {
    const obj: any = {};
    if (message.taskId !== "") {
  ...
  create<I extends Exact<DeepPartial<MsgCreateAudioStemTaskResponse>, I>>(
    base?: I,
  ): MsgCreateAudioStemTaskResponse {
    return MsgCreateAudioStemTaskResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgCreateAudioStemTaskResponse>, I>>(
    object: I,
  ): MsgCreateAudioStemTaskResponse {
    const message = createBaseMsgCreateAudioStemTaskResponse();
...
export interface Msg {
  ...
  CreateAudioStemTask(request: MsgCreateAudioStemTask): Promise<MsgCreateAudioStemTaskResponse>;
  /** Adds a new worker */
...
export const MsgServiceName = "janction.audioStem.v1.Msg";
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.rpc = rpc;
    this.CreateAudioStemTask = this.CreateAudioStemTask.bind(this);
  ...
  CreateAudioStemTask(request: MsgCreateAudioStemTask): Promise<MsgCreateAudioStemTaskResponse> {
    const data = MsgCreateAudioStemTask.encode(request).finish();
    const promise = this.rpc.request(this.service, "CreateAudioStemTask", data);
    return promise.then((data) => MsgCreateAudioStemTaskResponse.decode(new BinaryReader(data)));
  }
