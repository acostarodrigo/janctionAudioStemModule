...
// --- Test for GetEmptyAudioStemTaskList ---
func TestGetEmptyAudioStemTaskList(t *testing.T) {
	list := GetEmptyAudioStemTaskList()
	require.Equal(t, []IndexedAudioStemTask{}, list)
}
