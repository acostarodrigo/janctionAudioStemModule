...
const (
	Msg_CreateAudioStemTask_FullMethodName   = "/janction.audioStem.v1.Msg/CreateAudioStemTask"
	Msg_AddWorker_FullMethodName             = "/janction.audioStem.v1.Msg/AddWorker"
	Msg_SubscribeWorkerToTask_FullMethodName = "/janction.audioStem.v1.Msg/SubscribeWorkerToTask"
	Msg_ProposeSolution_FullMethodName       = "/janction.audioStem.v1.Msg/ProposeSolution"
	Msg_SubmitValidation_FullMethodName      = "/janction.audioStem.v1.Msg/SubmitValidation"
	Msg_RevealSolution_FullMethodName        = "/janction.audioStem.v1.Msg/RevealSolution"
	Msg_SubmitSolution_FullMethodName        = "/janction.audioStem.v1.Msg/SubmitSolution"
)
...
func (c *msgClient) CreateAudioStemTask(ctx context.Context, in *MsgCreateAudioStemTask, opts ...grpc.CallOption) (*MsgCreateAudioStemTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_CreateAudioStemTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) CreateAudioStemTask(context.Context, *MsgCreateAudioStemTask) (*MsgCreateAudioStemTaskResponse, error) {
...
func _Msg_CreateAudioStemTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_CreateAudioStemTask_FullMethodName,
	}
